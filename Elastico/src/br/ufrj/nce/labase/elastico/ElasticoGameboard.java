...
public class ElasticoGameboard extends GameBoard {
	...
	public static void main(String[] args) {
		...
		ElasticoGameboard applet = new ElasticoGameboard();
		applet.init();
		applet.start();
	...
	private void inicializaCartas() {
		...
		for (int x = 0; (x + WIDTH_CARTA) < WIDTH; x += WIDTH_CARTA) {
			image = Images.getBufferedImage(this.getClass(), this.getImageName(cartas.get(idimagem) + " [80x60].GIF"));
			this.addSprite(new Carta(this.spriteManager, new Point2D.Double(x, 0), image, listFilter));

			image = Images.getBufferedImage(this.getClass(), this.getImageName(cartas.get(idimagem + 1) + " [80x60].GIF"));
	...
	private void inicializaPinoEstatico() {
		BufferedImage image = Images.getBufferedImage(this.getClass(), this.getImageName("Pino2[80x60].jpg"));
		this.pinoEstatico = new PinoEstatico(new Point2D.Double(PAINEL_X_MIN, PAINEL_Y_MIN + 15), image);
	}
	...
	public void paintPhaseOne(Graphics g) {
		...
		BufferedImage im = Images.getBufferedImage(this.getClass(), this.getImageName("collage.jpg"));
