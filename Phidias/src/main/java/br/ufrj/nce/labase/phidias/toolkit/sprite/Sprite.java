...
public class Sprite {
	 ...
	 *  
	 * @param listener the SpriteActionListener to be added.
	 */
	 ...
	 *  
	 * @param listener the SpriteActionListener to be removed.
	 */
	...
	/**
	 * Fires a SpriteActionEvent to all SpriteActionListeners added to this Sprite.
	 */
	...
	public List<Sprite> objectsCollided() {
 	 ...
 	 * In case of particular treatment of this event is needed, this method must be overriden by subclass.
 	 * 
 	 */
	...
	/** 
	 * Register in the server database that the user removed this Sprite from the board.
	 */
	...
	/** 
	 * Register in the server database that the user put this Sprite on the board.
	 */
	...
	/** 
	 * Register in the server database that the user moved this Sprite on the board.
	 */
	...
	/** 
	 * Register in the server database that this Sprite collided with another Sprite.
	 */
