...
public abstract class Player extends Applet {
    ...
    protected Board createBoard(String backgroundImageName){
    	...
    	Image backgroundImage = getImage(getCodeBase(), backgroundImageName);
    	background.setImage(backgroundImage);
		Board b = new Board(this, getWidth(), getHeight(), background);
		return b;
	}
...
*/
	...
	protected void setBoardImage(String boardImageName, Board board) {
		Sprite sprite = new Sprite();
		Image image = getImage(getCodeBase(), boardImageName);
