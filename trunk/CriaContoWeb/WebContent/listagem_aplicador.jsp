...
<%@page import="br.ufrj.nce.labase.phidias.persistence.model.Attendant"%>
...
<h2 class="title">Listagem de Aplicadores</h2>
	...
	<%
		if (request.getAttribute("listagem") != null) {
			...
			for (int i = 0; i < listagem.size(); i++) {
				attendant = (Attendant) listagem.get(i);
	%>

	<tr>
		<td><%= attendant.getId() %></td>
		<td><%= attendant.getName() %></td>
	</tr>
	<%
			}
		}
